...
<body>
	...
	<div class="container cart">
		<div class="span24">
				...
				<tbody>
					...
					<c:forEach var="orderItem" items="${s_cart}">
						<tr>
							...
							<td width="140"><span class="subtotal">SEK${orderItem.price * orderItem.count} kr</span></td>
						</tr>
			...
			<div class="total">
				<em id="promotion"></em> Commodity Price: <strong id="effectivePrice">SEK${total } kr
				</strong>
			</div>
